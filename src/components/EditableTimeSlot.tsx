...
export function EditableTimeSlot({
  ...
  return (
    ...
    >
            ...
            <>
              ...
              <div className="flex-1">
                {editingThisSlot && isEditing ? (
                  ...
                  >
                    <div className="font-medium text-sm">{booking.projectName}</div>
                    <div className="text-xs opacity-90">
                      {booking.memberName} • {formatHour(booking.startHour)} - {formatHour(booking.endHour)}
                      {booking.location && ` • ${booking.location}`}
                    </div>
                    {/* {booking.description && (
                      <div className="text-xs opacity-75 mt-1">{booking.description}</div>
                    )} */}
                  </div>
                )}
              </div>
      ...
      {/* BookingDetailsDialog not included here but add if you want */}
      {booking && (
